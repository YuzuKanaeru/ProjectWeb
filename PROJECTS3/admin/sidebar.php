...
$koneksii = new mysqli("localhost", "sivosism_db", "26Desember2003.", "sivosism_db");
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="../aset/img/logoosis.png" alt="" style="width: 40px; height: 40px;">
